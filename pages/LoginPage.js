...
export class LoginPage extends BasePage{
    ...
    constructor(page){
        super(page)
        this.page = page
        this.logioutLink = this.page.getByRole("link", {name:"Logout"}).first()
        this.myAcountLink = this.page.getByRole("link", {name: "My Account"}).first()
    ...
    async login(userName, password){
      ...
      await  this.fill(this.txtEmail,userName, "email text box not visible on login screen")
      await  this.fill(this.txtPassword,password, "email text box not visible on login screen")
